...
const args = require('commander')
    ...
    .option( '-d --ttyDevice <dev>', 'device name [COM1]', getString, TTY_DEFAULTS.ttyDevice )
    .option( '-b --baudRate <baud>', '[1200], 9600 or 38400', getInt, 1200 )
    .option( '--dataBits <bits>', '7 or [8]', getInt, 7 )
